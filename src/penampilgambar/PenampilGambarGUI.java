 ...
 * @author User
 */
public class PenampilGambarGUI extends javax.swing.JFrame {

    /**
     * Creates new form PenampilGambarGUI
     */
    public PenampilGambarGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenampilGambarGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PenampilGambarGUI().setVisible(true);
            }
        });
    }
